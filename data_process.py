...
class AmazonReviewsDatasetSplit:
    def __init__(self, csv_file, tokenizer, max_len, train_size=0.8, val_size=0.1, test_size=0.1):
    ...
    def __split_data(self):
        ...
        val_data = self.data.drop(train_data.index).sample(frac=0.5, random_state=42)
